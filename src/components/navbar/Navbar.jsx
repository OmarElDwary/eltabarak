...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar bg-[#07070A]">
      <Image
        src={logo}
        alt="logo"
        width={124}
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        {toggle ? (
            <AiOutlineClose
            className={`color-white w-[40px] h-[40px] cursor-pointer mr-4`}
            onClick={() => setToggle(false)}
          />
        ) : (
          <CgMenuGridR
            className={`color-white w-[40px] h-[40px] cursor-pointer mr-4 mt-4`}
